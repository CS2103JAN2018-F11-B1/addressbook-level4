...
include::../UserGuide.adoc#38-editing-nonessential-details-of-a-person--editdetails,Edit Details

include::../UserGuide.adoc#39-converting-a-person--con-convert,Convert
...
include::../DeveloperGuide.adoc#35-leads-and-contacts-feature,Leads and Contacts
