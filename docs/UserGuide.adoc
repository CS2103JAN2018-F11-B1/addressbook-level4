...
* In v 1.2: Able to add leads into CRM book and convert leads into contacts. All commands can be performed via its alias. Able to start process of LinkedIn Integration

* In v 1.3: Introduce calander for meetings. Able to detect duplicates based on phone number. Able to fully authenticate linkedIn, and link contacts to linkedIn. At least two alias commands will be completed.

* In v 1.4: Able to book meetings using the calander. Able to detect duplicates based on email address and able to display a list of Leads. CRM Book will alert you if a contact switches companies.

* In v 1.5: Able to display a list of either Leads or Contacts.
