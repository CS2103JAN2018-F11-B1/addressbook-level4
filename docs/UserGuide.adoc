...
* In v 1.2: Able to add leads into CRM book and convert leads into contacts. Completion of alias command alias. Able to start process of LinkedIn Integration
...
* In v 1.4: Able to book meetings using the calander. Able to list out Leads. Duplicate detection based on email address. CRM Book will alert you if a contact switches companies.

* In v 1.5: Able to list out Leads and Contacts.
