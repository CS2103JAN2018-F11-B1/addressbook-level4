...
* In v 1.2: Able to add leads into CRM book and convert leads into contacts. All commands can be performed via its respective alias. Able to start process of LinkedIn Integration. Able to generate a color for the tags added.
...
* In v 1.4: Able to book meetings using the calander. Duplicate detection based on email address. Able to list out Leads at user's request. CRM Book will alert you if a contact switches companies. At least two alias commands will be completed.
