...
* In v 1.3: Introduce calander for meetings. Duplicate detection based on phone number. Able to fully authenticate linkedIn, and link contacts to linkedIn.

* In v 1.4: Able to book meetings using the calander. Duplicate detection based on email address. Able to list out Leads stored. CRM Book will alert you if a contact switches companies.

* In v 1.5: Able to list out Leads and Contacts at user's request.
