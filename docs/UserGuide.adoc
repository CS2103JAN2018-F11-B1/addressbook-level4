...
* In v 1.2: Able to add leads into CRM book and convert leads into contacts. Able to execute commands using its alias. Able to start process of LinkedIn Integration. Able to generate a color for the tags added.

* In v 1.3: Introduce calander for meetings. Able to detect based on phone number. Able to fully authenticate linkedIn, and link contacts to linkedIn. At least two alias commands will be completed.

* In v 1.4: Able to book meetings using the calander. Able to detect based on email address. Able to list out Leads at user's request. CRM Book will alert you if a contact switches companies. At least two alias commands will be completed.

* In v 1.5: Able to list out Contacts at user's request.
