...
* In v 1.3: Introduce calander for meetings. Able to detect duplicates based on phone number. Able to fully authenticate linkedIn, and link contacts to linkedIn.
...
* In v 1.5: Able to display a list of Leads and a list of Contacts.
