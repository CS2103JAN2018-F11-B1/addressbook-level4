...
Examples:
* `e 4 n/Harry Tan +
Edits the name of the 1st person to be `Harry Tan`.
...
* `list` +
`d 4` +
Deletes the 4thperson in the address book.
...
* `delete 4` +
`u` (reverses the `delete 4` command) +
`r` (reapplies the `delete 4` command) +
...
e.g. `d 3`, `delete 6`
* *Edit* : `e INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS], `edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]...` +
e.g. `e 2 p/99991234`, `edit 2 n/James Lee e/jameslee@example.com`
* *Find* : `f KEYWORD [MORE_KEYWORDS]`, `find KEYWORD [MORE_KEYWORDS]` +
e.g. `f Tom`, `find James Jake`
* *List* : `l`, `list`
* *Help* : `h`, `help`
