...
|`* * *` |salesperson |obtain a list of either Leads or Contacts|keep track potential sales targets and past sales transactions
...
|`*` |salesperson that types fast|execute a command with as few types as possible|use my CRM Book efficiently
...
1.  User requests to list all Leads and Contacts
2.  CRM shows a list of Leads and Contacts
3.  User requests to delete a specific Lead or Contact in the list
4.  AddressBook deletes the specified Lead or Contact
+
Use case ends.
...
+
[none]
** 3a1. CRM shows an error message.
+
...
2. CRM determines if Lead can be added
3. CRM displays message on whether Lead entered can be added or is a duplicate
+
Use case ends.
