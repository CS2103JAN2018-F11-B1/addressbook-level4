...
|`**` |salesperson that types fast|execute a command with as few types as possible|use my CRM Book faster
...
1.  User requests to list of Leads and Contacts
2.  CRM shows a list of persons
3.  User requests to delete a specific Lead or Contact in the list
4.  CRM deletes the Lead or Contact
+
Use case ends.
